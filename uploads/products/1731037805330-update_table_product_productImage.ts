...
export class UpdateTableProductProductImage1731037805330 implements MigrationInterface {
    name = 'UpdateTableProductProductImage1731037805330'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order\` CHANGE \`storeId\` \`storeId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`store\` DROP COLUMN \`storeAddress\``);
        await queryRunner.query(`ALTER TABLE \`store\` ADD \`storeAddress\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`order\` CHANGE \`voucherId\` \`voucherId\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`order\` CHANGE \`storeId\` \`storeId\` int NOT NULL`);
