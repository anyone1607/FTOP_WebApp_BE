...
export class UpdateVoucherColumnDelete1731341338322 implements MigrationInterface {
    name = 'UpdateVoucherColumnDelete1731341338322'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`voucher\` ADD \`deletedAt\` timestamp NULL`);
