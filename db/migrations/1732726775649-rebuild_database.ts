...
export class RebuildDatabase1732726775649 implements MigrationInterface {
    name = 'RebuildDatabase1732726775649'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`store\` (\`storeId\` int NOT NULL AUTO_INCREMENT, \`storeName\` varchar(50) NOT NULL, \`storeAddress\` varchar(255) NOT NULL, \`storePhone\` int NOT NULL, \`ownerId\` int NOT NULL, \`status\` tinyint NOT NULL, UNIQUE INDEX \`REL_a83068090fe4511e5047484b09\` (\`ownerId\`), PRIMARY KEY (\`storeId\`)) ENGINE=InnoDB`);
