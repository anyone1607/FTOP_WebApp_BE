...
export class UpdateFieldCashoutTableOrder1736247348228 implements MigrationInterface {
    name = 'UpdateFieldCashoutTableOrder1736247348228'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order\` ADD \`isCashedOut\` tinyint NOT NULL DEFAULT 0`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`email\``);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`email\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`order\` DROP COLUMN \`isCashedOut\``);
