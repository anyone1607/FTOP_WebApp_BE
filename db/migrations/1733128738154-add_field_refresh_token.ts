...
export class AddFieldRefreshToken1733128738154 implements MigrationInterface {
    name = 'AddFieldRefreshToken1733128738154'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`store\` CHANGE \`ownerId\` \`ownerId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`store\` ADD UNIQUE INDEX \`IDX_a83068090fe4511e5047484b09\` (\`ownerId\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`store\` DROP INDEX \`IDX_a83068090fe4511e5047484b09\``);
        await queryRunner.query(`ALTER TABLE \`store\` CHANGE \`ownerId\` \`ownerId\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`store\` DROP COLUMN \`storeAddress\``);
        await queryRunner.query(`ALTER TABLE \`store\` ADD \`storeAddress\` varchar(255) NOT NULL`);
