...
export class UpdateDatabase1734545903252 implements MigrationInterface {
    name = 'UpdateDatabase1734545903252'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`store\` CHANGE \`storeImage\` \`storeImage\` json NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`store\` CHANGE \`storeImage\` \`storeImage\` json NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`store\` DROP COLUMN \`storeAddress\``);
        await queryRunner.query(`ALTER TABLE \`store\` ADD \`storeAddress\` varchar(255) NOT NULL`);
