...
export class UpdateOrdercolumnTableTransaction1732270266212 implements MigrationInterface {
    name = 'UpdateOrdercolumnTableTransaction1732270266212'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`walletBalance\` decimal(10,2) NOT NULL DEFAULT '0.00'`);
        ...
        await queryRunner.query(`ALTER TABLE \`transaction\` CHANGE \`orderId\` \`orderId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`transaction\` CHANGE \`orderId\` \`orderId\` int NOT NULL`);
